<template>
  <a-card :bordered="false" class="card-area">
    ...
    <cost-add
      v-if="costAdd.visiable"
      @close="handlecostAddClose"
      @success="handlecostAddSuccess"
      :costAddVisiable="costAdd.visiable">
    </cost-add>
    <cost-edit
      ref="costEdit"
      @close="handlecostEditClose"
...
export default {
  ...
  methods: {
    ...
    add () {
      this.costAdd.visiable = true
    },
    handlecostAddClose () {
      this.costAdd.visiable = false
    },
    handlecostAddSuccess () {
      this.costAdd.visiable = false
      this.$message.success('新增成本成功')
      this.search()
    },
    edit (record) {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/cost-info/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/job-cost-order/page', {
        ...params
      }).then((r) => {
